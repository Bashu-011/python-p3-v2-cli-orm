...
def create_employee():
    try:
        ...
        print(f'Success: Employee {employee.name} created with job title {employee.job_title} and department id {employee.department_id}.')
    except Exception as exc:
...
def update_employee():
    ...
    if employee:
        try:
            ...
            new_department = input("Enter the employee's new department id: ")
